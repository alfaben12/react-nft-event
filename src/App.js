...
const CONTRACT_ADDR = "0xa182519eae0ec738373293adef919679051b5b84";

const provider = new ethers.providers.JsonRpcProvider(
  "https://rpc-mumbai.maticvigil.com" // It cam be different network
);
...
export default function App() {
  ...
  useEffect(() => {
    const fetchOldEvents = async () => {
      const items = await contract.queryFilter(filterFrom, 24291827, 24292531);
      items.forEach((item) => {
